...
const Resume = () => {
  ...
  const experience = {
    ...
    items: [
      {
        company: "MTA NYCT",
        position: "ArcGIS Developer Intern",
  ...
  return (
    <motion.div 
      initial={{opacity: 0}} 
      animate={{opacity: 1, transition: {delay: 0.3, duration: 0.2, ease: "easeIn"}}} 
              ...
              <div className="flex flex-col gap-[30px]">
                ...
                <ul className="grid grid-cols-1 xl:grid-cols-2 gap-y-6 max-w-[620px] mx-auto xl:mx-0">
                  {about.info.map((item, index) => {
                    return (
                      <li key={index} className="flex items-center justofy-center xl:justify-start gap-4">
                ...
                <ScrollArea className="h-[480px]">
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                    {experience.items.map((item, index) => {
                      return (
                        <li key={index} className="bg-[#232239] h-[184px] py-6 px-10 rounded-xl flex flex-col justify-center items-center lg:items-start gap-1">
                  ...
                  <ScrollArea className="h-[480px]">
                    <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                      {education.items.map((item, index) => {
                        return (
                          <li key={index} className="bg-[#232239] h-[184px] py-6 px-10 rounded-xl flex flex-col justify-center items-center lg:items-start gap-1">
                            <span className="text-accent">{item.school}</span>
